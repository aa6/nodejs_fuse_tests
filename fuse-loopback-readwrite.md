...
### init(cb)
Called on filesystem initialization, prior to all other functions[.](/spec/fuse-loopback-readwrite.spec.coffee#L360) Called only one time per each mount. Always accepts only one input argument.
